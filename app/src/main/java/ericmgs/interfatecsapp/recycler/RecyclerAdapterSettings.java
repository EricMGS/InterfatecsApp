...
public class RecyclerAdapterSettings extends RecyclerView.Adapter {
    private Context context;
    private final List<String> labels;

    public RecyclerAdapterSettings(List<String> labels, Context context) {
        this.labels = labels;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolderRecyclerSettings(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ViewHolderRecyclerSettings vh = (ViewHolderRecyclerSettings) holder;
